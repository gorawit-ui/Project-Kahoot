...
export const sampleQuestions: QuizQuestion[] = [
  ...
  { id: 3, prompt: "บ้านเกิดจิ๊กโก๋อยู่จังหวัดไหน", choices: ["ย่าโม", "พิษณุโลก", "เชียงใหม่", "เขาใหญ่"], correctIndex: 1, answer: "พิษณุโลก", imageUrl: "/assets/questions/question-03.png", imageFrame: "square", imageShape: "circle", imageFit: "contain" },
  { id: 4, prompt: "จิ๊กโก๋มีชื่อเล่นจริงๆ ว่าอะไร", choices: ["จิ๋ว", "จิ๊กโก๋", "ครีม", "จิ๊กกี๋"], correctIndex: 2, answer: "ครีม", imageUrl: "/assets/questions/question-04.jpg", imageFrame: "portrait", imageShape: "rounded", imageFit: "contain" },
  { id: 5, prompt: "จิ๊กโก๋กรุ๊ปเลือดอะไร", choices: ["A", "B", "AB", "O"], correctIndex: 1, answer: "B", imageUrl: "/assets/questions/question-05.jpg", imageFrame: "portrait", imageShape: "square", imageFit: "contain" },
  { id: 6, prompt: "เพลงแรกที่ร้อง 3 คน เพลงอะไร", choices: ["โต๊ะหมู่", "โต๊ะริม", "โต๊ะริมทาง", "โต๊ะพึมๆ"], correctIndex: 1, answer: "โต๊ะริม", imageUrl: "/assets/questions/question-06.jpg", imageFrame: "tall", imageShape: "rounded", imageFit: "contain" },
